...
public class UseCaseTest extends AbstractTest {
    ...
    public void productsPerRequestJpaTest() {
        EntityManager entityManager = em();
        List<Request> requests = entityManager.createNamedQuery("requestWithProducts", Request.class).setMaxResults(MAX_RESULT).getResultList();
