...
import de.inverso.jooqexample.gen.public_.tables.Bankdetails;
...
public abstract class AbstractTest {
    ...
    static void tearDown() {
       ...
       DatabaseUtil.executeQuery(em, connection -> {
           DSL.using(connection).truncate(de.inverso.jooqexample.gen.public_.tables.Person.PERSON);
           DSL.using(connection).truncate(de.inverso.jooqexample.gen.public_.tables.Request.REQUEST);
           DSL.using(connection).truncate(de.inverso.jooqexample.gen.public_.tables.Broker.BROKER);
           return DSL.using(connection).truncate(Bankdetails.BANKDETAILS);
       });
    }
